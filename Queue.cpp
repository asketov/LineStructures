#include <iostream>
 /*
 Задача 2.	Структура данных – очередь.
Уровень сложности – повышенный. Реализовать необходимую для решения задачи структуру данных с помощью двух структур хранения: векторной и связной, 
– реализацию оформить в виде иерархии классов. 
Абстрактный базовый класс должен задавать интерфейс, а производные – реализацию структуры данных. 
В программе, решающей поставленную задачу, выбор структуры хранения предоставить пользователю. 
Многочлены вида  , где e1>e2>…>en≥0, можно представить в виде очереди, где каждый элемент имеет два поля: одно – для коэффициента c(i), 
второе – для показателя степени e(i). 
Напишите программу вычитания многочленов, представленных описанным образом. 
*/
struct DataType
{
    double coef, degree;

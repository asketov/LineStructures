...
public:
 ...
 bool EnQueue(DataType info) override /*перераспределение виртуальной функции добавле
ния элемента в структуру хранения*/
 {
 ...
 DataType DeQueue(void) override /*перераспределение виртуальной функции чтения элеме
нта из структуры хранения*/
 {
...
int main()
{
 ...
 char choise;
 int n1, n2, i = 1;
 cout << "Выберите структуру хранения:" << endl << "1. Векторная" << endl << "2. Связная
" << endl;
 choise = getchar();
 system("cls");
 if (choise == '1')
